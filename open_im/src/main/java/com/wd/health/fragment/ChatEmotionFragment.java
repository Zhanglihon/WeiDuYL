...
import com.wd.health.adapter.EmotionGridViewAdapter;
import com.wd.health.adapter.EmotionPagerAdapter;
import com.wd.health.base.BaseFragment;
import com.wd.health.util.EmotionUtils;
import com.wd.health.util.GlobalOnItemClickManagerUtils;
import com.wd.health.util.Utils;
import com.wd.health.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = WDApplication.screenWidth;
        // item的间距
