...
import com.wd.health.util.AudioRecoderUtils;
import com.wd.health.util.PopupWindowFactory;
import com.wd.health.util.Utils;
...
import zhang.bw.com.common.core.PushMessage;
...
//                            Toast.makeText(mActivity, "发送成功", Toast.LENGTH_SHORT).show();
    ...
    public EmotionInputDetector bindToVoiceButton1(List<MessageInfo> messageInfos) {
        return this;
    }

    class Backi implements DataCall{
