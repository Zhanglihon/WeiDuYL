...
import com.bw.open_wallet.prensenter.ShengFzPresenter;
...
public class ShengFenActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_shengfz);
        context = this;
    ...
    private void getOcrSing() {
        ...
        }, getApplicationContext(), "27F7KpkPXcGed4vaDOA0CKNI", "ZRozU2qYrGacu5QRHakkkeEGls3iAdo0");
    }


    private void initView() {
        loginBean = DaoMaster.newDevSession(ShengFenActivity.this,LoginBeanDao.TABLENAME).getLoginBeanDao().loadAll().get(0);
       /* tv_b_n =findViewById(R.id.tv_b_n);*/
    ...
    /*    iv_bank = (ImageView) findViewById(R.id.iv_bank);*/
      ...
      //  rl_bk.setOnClickListener(this);
        ShengFzPresenter shengFzPresenter=new ShengFzPresenter(new sfz());
        Map<String,String> hasMap=new HashMap<>();
        hasMap.put("name",name);
        hasMap.put("sex",sex);
        hasMap.put("nation",nation);
        hasMap.put("birthday",birthday);
        hasMap.put("address",address);
        hasMap.put("id_number",id_number);
        String s=JsonUtil.parseMapToJson(hasMap);
        RequestBody body = RequestBody.create(MediaType.parse("application/json;charset=UTF-8"), s);
        //shengFzPresenter.reqeust(loginBean.getId(),loginBean.getSessionId(),body);
    }
    ...
    public void onClick(View view) {
      ...
      if (i == R.id.iv_id_front) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                Intent intent = new Intent(ShengFenActivity.this, CameraScanActivity.class);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                Intent intent2 = new Intent(ShengFenActivity.this, CameraScanActivity.class);
    ...
    private void requestCameraPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            // 这里重新申请权限
            ActivityCompat.requestPermissions(ShengFenActivity.this,
